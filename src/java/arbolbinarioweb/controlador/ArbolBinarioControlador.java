...
public class ArbolBinarioControlador implements Serializable {
    ...
    public void setVerPorNivelesOrden(boolean verPorNivelesOrden) {
        this.verPorNivelesOrden = verPorNivelesOrden;
    }
    ...
    public void habilitarPorNivelesOrden() {
        try {
            arbol.isLleno();
            verPorNivelesOrden = true;
        } catch (ArbolBinarioException ex) {
            JsfUtil.addErrorMessage(ex.getMessage());
        }
    }
